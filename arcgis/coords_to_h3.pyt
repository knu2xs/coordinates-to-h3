...
if importlib.util.find_spec("coords_to_h3") is None:
    src_dir = find_pkg_source("coords_to_h3")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "coordinates-to-h3"
        self.alias = "coords_to_h3"
...
class CreateDataDirectory:
    ...
    def execute(self, parameters, messages):
        ...
        coords_to_h3.utils.configure_logging("INFO")
        ...
        coords_to_h3.utils.build_data_resources(dir_data)
